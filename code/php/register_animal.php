...
<html lang="en">
	...
	<body>
		<?php
			...
			// ajouter des annimaux avec le formulaire
		?>
			...
			<article class="row main">
				...
				<h5>Sign up once and watch any of our free demos.</h5>
					<form class="" method="post" action="#">
                        ...
                        <div class="form-group">
							<label for="name" class="cols-sm-2 control-label">le nom</label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa" aria-hidden="true"></i></span>
						...
						<div class="form-group">
							<label for="weight" class="cols-sm-2 control-label">le poid</label>
							<div class="cols-sm-10">
								<div class="input-group">
						...
						<div class="form-group">
							<label for="gender" class="cols-sm-2 control-label">Le genre</label>
							<div class="cols-sm-10">
								<div class="input-group">
                        ...
                        <div class="form-group">
							<a href="./animal.php" class="text-info">ma liste d'animaux</a><br>
